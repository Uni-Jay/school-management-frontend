...
const defaultNavItems: NavItem[] = [
  ...
  { label: "Role Management", icon: <ShieldCheck size={20} />, path: "/super_admin/role_management" },
  { label: "School Super Admin", icon: <Users size={20} />, path: "/super_admin/user_management" },
